I want to add a feeds detail page which shows all the details for a feed.

On the feeds listing page I want to get all the details of a feed by clicking on it.

Also, on the feeds listing page, I want a filter to show only disabled feeds.
...
Your objective is to create a markdown document with user stories and acceptance criteria, called an "epic document", and put it in the user-stories/ directory.
